...
LogFlight::LogFlight(string name0)
{
    ...
    // states
    fp_posi = fopen(("/home/johanna/src/large_scale_plannctrl/logs/" + name + "_posi.txt").c_str(), "w+");
    fp_velo = fopen(("/home/johanna/src/large_scale_plannctrl/logs/" + name + "_velo.txt").c_str(), "w+");

    // desires
    fp_posid = fopen(("/home/johanna/src/large_scale_plannctrl/logs/" + name + "_posid.txt").c_str(), "w+");
    fp_velod = fopen(("/home/johanna/src/large_scale_plannctrl/logs/" + name + "_velod.txt").c_str(), "w+");
}
